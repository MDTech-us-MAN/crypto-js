...
This repo was created entirely for the purpose of hosting crypto-js on github since Google Code is closing down. I did *NOT* write this code. You can always reference this code using the GitHub Pages hosting located at: http://mdtech-us-man.github.io/crypto-js/.
